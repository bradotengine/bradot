// Compatibility renames. These are exposed with the "bradot_" prefix
// to work around two distinct Adreno bugs:
// 1. Some Adreno devices expose ES310 functions in ES300 shaders.
//    Internally, we must use the "bradot_" prefix, but user shaders
...
#define packUnorm4x8 bradot_packUnorm4x8
#define unpackUnorm4x8 bradot_unpackUnorm4x8
#define packSnorm4x8 bradot_packSnorm4x8
#define unpackSnorm4x8 bradot_unpackSnorm4x8
