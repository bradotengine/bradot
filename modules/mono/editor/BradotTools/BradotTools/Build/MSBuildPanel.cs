...
#nullable enable
        ...
        public void BuildProject()
        {
            ...
            BradotSharpEditor.Instance.GetNode<HotReloadAssemblyWatcher>("HotReloadAssemblyWatcher").RestartTimer();
        ...
        private void OpenLogsFolder() => OS.ShellOpen(
            $"file://{BradotSharpDirs.LogsDirPathFor("Debug")}"
        );
        ...
        public void OnBeforeSerialize()
        {
            ...
            // NOTE:
            // Currently, BradotTools is loaded in its own load context. This load context is not reloaded, but the script still are.
