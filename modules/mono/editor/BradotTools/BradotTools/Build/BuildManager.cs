...
namespace BradotTools.Build
{
    public static class BuildManager
    {
        ...
        {
            var dllName = $"{BradotSharpDirs.ProjectAssemblyName}.dll";
            var path = Path.Combine(BradotSharpDirs.ProjectBaseOutputPath, "Debug", dllName);
        ...
        {
            var plugin = BradotSharpEditor.Instance;
        ...
        {
            var buildInfo = new BuildInfo(BradotSharpDirs.ProjectSlnPath, BradotSharpDirs.ProjectCsProjPath, configuration,
            ...
            if (platform != null || Utils.OS.PlatformNameMap.TryGetValue(OS.GetName(), out platform))
                buildInfo.CustomProperties.Add($"BradotTargetPlatform={platform}");

            if (Internal.BradotIsRealTDouble())
                buildInfo.CustomProperties.Add("BradotFloat64=true");
        ...
        public static bool EditorBuildCallback()
        {
            ...
            if (BradotSharpEditor.Instance.SkipBuildBeforePlaying)
