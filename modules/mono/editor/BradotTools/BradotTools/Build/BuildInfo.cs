...
namespace BradotTools.Build
{
    ...
    public sealed partial class BuildInfo : RefCounted // TODO Remove RefCounted once we have proper serialization
    {
        ...
        public Bradot.Collections.Array CustomProperties { get; private set; } = new();

        public string LogsDirPath => BradotSharpDirs.LogsDirPathFor(Solution, Configuration);
        ...
        // Needed for instantiation from Bradot, after reloading assemblies
        private BuildInfo()
        {
