...
{
    public static class BradotSharpDirs
    {
        public static string ResMetadataDir
        {
            get
            {
                Internal.bradot_icall_BradotSharpDirs_ResMetadataDir(out bradot_string dest);
                using (dest)
        ...
        public static string MonoUserDir
        {
            get
            {
                Internal.bradot_icall_BradotSharpDirs_MonoUserDir(out bradot_string dest);
                using (dest)
                    return Marshaling.ConvertStringToManaged(dest);
            }
        }
        ...
        public static string BuildLogsDirs
        {
            get
            {
                Internal.bradot_icall_BradotSharpDirs_BuildLogsDirs(out bradot_string dest);
                using (dest)
                    return Marshaling.ConvertStringToManaged(dest);
            }
        }
        ...
        public static string DataEditorToolsDir
        {
            get
            {
                Internal.bradot_icall_BradotSharpDirs_DataEditorToolsDir(out bradot_string dest);
                using (dest)
                    return Marshaling.ConvertStringToManaged(dest);
            }
        }
        ...
        public static string CSharpProjectName
        {
            get
            {
                Internal.bradot_icall_BradotSharpDirs_CSharpProjectName(out bradot_string dest);
                using (dest)
                    return Marshaling.ConvertStringToManaged(dest);
            }
        }
        ...
        public static void DetermineProjectLocation()
        {
            ...
            // The csproj should be in the same folder as project.bradot.
        ...
        public static string ProjectBaseOutputPath
        {
            get
            {
                if (_projectCsProjPath == null)
                    DetermineProjectLocation();
                return Path.Combine(Path.GetDirectoryName(_projectCsProjPath)!, ".bradot", "mono", "temp", "bin");
            }
        }
