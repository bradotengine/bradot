...
public partial class VisualShaderNode_CLASS_ : _BASE_
{
    ...
    public override string _GetCode(Bradot.Collections.Array<string> inputVars, Bradot.Collections.Array<string> outputVars, Shader.Mode mode, VisualShader.Type type)
    {
        return "";
    }
}
