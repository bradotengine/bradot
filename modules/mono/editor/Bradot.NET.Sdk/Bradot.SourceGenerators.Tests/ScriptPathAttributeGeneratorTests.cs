...
public class ScriptPathAttributeGeneratorTests
{
    ...
    {
        return (
            Path.Combine("Bradot.SourceGenerators", "Bradot.SourceGenerators.ScriptPathAttributeGenerator", "AssemblyScriptTypes.generated.cs"),
            SourceText.From($$"""
            [assembly:Bradot.AssemblyHasScriptsAttribute(new System.Type[] {{{string.Join(", ", types.Select(type => $"typeof({type})"))}}})]
    ...
    public async void GenericMultipleClassesSameName()
    {
        ...
        verifier.TestState.Sources.Add(("Generic.cs", File.ReadAllText(Path.Combine(Constants.SourceFolderPath, "Generic.BR0003.cs"))));
    ...
    public async void NamespaceMultipleClassesSameName()
    {
        ...
        verifier.TestState.Sources.Add(("SameName.cs", File.ReadAllText(Path.Combine(Constants.SourceFolderPath, "SameName.BR0003.cs"))));
