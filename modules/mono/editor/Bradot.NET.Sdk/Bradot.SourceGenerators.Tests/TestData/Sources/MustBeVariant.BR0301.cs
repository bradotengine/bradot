...
using Array = Bradot.Collections.Array;

public class MustBeVariantBR0301
{
    public void MethodCallsError()
    {
        // This raises a BR0301 diagnostic error: object is not Variant (and Method<T> requires a variant generic type).
        Method<{|BR0301:object|}>();
    }
    ...
    public void MustBeVariantClasses()
    {
        ...
        new ClassWithGenericVariant<BradotObject>();
        ...
        new ClassWithGenericVariant<{|BR0301:object|}>();
    }
}
...
public class MustBeVariantAnnotatedMethods
{
    ...
    [GenericTypeAttribute<BradotObject>()]
    public void MethodWithAttributeBradotObject()
    {
    }
    ...
    [GenericTypeAttribute<BradotObject[]>()]
    public void MethodWithAttributeBradotObjectArray()
    {
    }
    ...
    [GenericTypeAttribute<{|BR0301:object|}>()]
...
[GenericTypeAttribute<BradotObject>()]
public class ClassVariantAnnotatedBradotObject
{
}
...
[GenericTypeAttribute<BradotObject[]>()]
public class ClassVariantAnnotatedBradotObjectArray
{
}
