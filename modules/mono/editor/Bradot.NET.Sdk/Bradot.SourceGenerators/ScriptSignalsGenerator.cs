...
namespace Bradot.SourceGenerators
{
    ...
    public class ScriptSignalsGenerator : ISourceGenerator
    {
        ...
        {
            if (context.IsBradotSourceGeneratorDisabled("ScriptSignals"))
                return;
        ...
        )
        {
            ...
            if (godotSignalDelegates.Count > 0)
            {
                ...
                source.Append("    /// <summary>\n")
                    ...
                    .Append("    /// This method is used by Bradot to register the available signals in the editor.\n")
            ...
            // Generate RaiseBradotClassSignalCallbacks
            ...
            if (godotSignalDelegates.Count > 0)
            {
                ...
                source.Append("    [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]\n");
                source.Append(
                    "    protected override void RaiseBradotClassSignalCallbacks(in bradot_string_name signal, ");
                ...
                source.Append("        base.RaiseBradotClassSignalCallbacks(signal, args);\n");
            ...
            if (godotSignalDelegates.Count > 0)
            {
                ...
                source.Append("        return base.HasBradotClassSignal(signal);\n");
        ...
        private static MethodInfo DetermineMethodInfo(BradotSignalDelegateData signalDelegateData)
        {
        ...
        private static void GenerateSignalEventInvoker(
            BradotSignalDelegateData signal,
            StringBuilder source
        )
        {
