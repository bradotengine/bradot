...
namespace Bradot.SourceGenerators
{
    public static partial class Common
    {
        ...
        internal static readonly DiagnosticDescriptor ClassPartialModifierRule =
            new DiagnosticDescriptor(id: "BR0001",
                title: $"Missing partial modifier on declaration of type that derives from '{BradotClasses.BradotObject}'",
                messageFormat: $"Missing partial modifier on declaration of type '{{0}}' that derives from '{BradotClasses.BradotObject}'",
                category: "Usage",
                DiagnosticSeverity.Error,
                isEnabledByDefault: true,
                $"Classes that derive from '{BradotClasses.BradotObject}' must be declared with the partial modifier.",
                helpLinkUri: string.Format(_helpLinkFormat, "BR0001"));

        internal static readonly DiagnosticDescriptor OuterClassPartialModifierRule =
            new DiagnosticDescriptor(id: "BR0002",
                title: $"Missing partial modifier on declaration of type which contains nested classes that derive from '{BradotClasses.BradotObject}'",
                messageFormat: $"Missing partial modifier on declaration of type '{{0}}' which contains nested classes that derive from '{BradotClasses.BradotObject}'",
                category: "Usage",
                DiagnosticSeverity.Error,
                isEnabledByDefault: true,
                $"Classes that derive from '{BradotClasses.BradotObject}' and their containing types must be declared with the partial modifier.",
                helpLinkUri: string.Format(_helpLinkFormat, "BR0002"));

        public static readonly DiagnosticDescriptor MultipleClassesInBradotScriptRule =
            new DiagnosticDescriptor(id: "BR0003",
                ...
                helpLinkUri: string.Format(_helpLinkFormat, "BR0003"));

        public static readonly DiagnosticDescriptor ExportedMemberIsStaticRule =
            new DiagnosticDescriptor(id: "BR0101",
                ...
                helpLinkUri: string.Format(_helpLinkFormat, "BR0101"));

        public static readonly DiagnosticDescriptor ExportedMemberTypeIsNotSupportedRule =
            new DiagnosticDescriptor(id: "BR0102",
                ...
                helpLinkUri: string.Format(_helpLinkFormat, "BR0102"));

        public static readonly DiagnosticDescriptor ExportedMemberIsReadOnlyRule =
            new DiagnosticDescriptor(id: "BR0103",
                ...
                helpLinkUri: string.Format(_helpLinkFormat, "BR0103"));

        public static readonly DiagnosticDescriptor ExportedPropertyIsWriteOnlyRule =
            new DiagnosticDescriptor(id: "BR0104",
                ...
                helpLinkUri: string.Format(_helpLinkFormat, "BR0104"));

        public static readonly DiagnosticDescriptor ExportedMemberIsIndexerRule =
            new DiagnosticDescriptor(id: "BR0105",
        ...
        public static readonly DiagnosticDescriptor ExportedMemberIsExplicitInterfaceImplementationRule =
            new DiagnosticDescriptor(id: "BR0106",
                ...
                helpLinkUri: string.Format(_helpLinkFormat, "BR0106"));

        public static readonly DiagnosticDescriptor OnlyNodesShouldExportNodesRule =
            new DiagnosticDescriptor(id: "BR0107",
                ...
                helpLinkUri: string.Format(_helpLinkFormat, "BR0107"));

        public static readonly DiagnosticDescriptor SignalDelegateMissingSuffixRule =
            new DiagnosticDescriptor(id: "BR0201",
                ...
                helpLinkUri: string.Format(_helpLinkFormat, "BR0201"));

        public static readonly DiagnosticDescriptor SignalParameterTypeNotSupportedRule =
            new DiagnosticDescriptor(id: "BR0202",
        ...
        public static readonly DiagnosticDescriptor SignalDelegateSignatureMustReturnVoidRule =
            new DiagnosticDescriptor(id: "BR0203",
                ...
                helpLinkUri: string.Format(_helpLinkFormat, "BR0203"));

        public static readonly DiagnosticDescriptor GenericTypeArgumentMustBeVariantRule =
            new DiagnosticDescriptor(id: "BR0301",
        ...
        public static readonly DiagnosticDescriptor GenericTypeParameterMustBeVariantAnnotatedRule =
            new DiagnosticDescriptor(id: "BR0302",
                ...
                helpLinkUri: string.Format(_helpLinkFormat, "BR0302"));

        public static readonly DiagnosticDescriptor TypeArgumentParentSymbolUnhandledRule =
            new DiagnosticDescriptor(id: "BR0303",
                ...
                helpLinkUri: string.Format(_helpLinkFormat, "BR0303"));

        public static readonly DiagnosticDescriptor GlobalClassMustDeriveFromBradotObjectRule =
            new DiagnosticDescriptor(id: "BR0401",
                title: $"The class must derive from {BradotClasses.BradotObject} or a derived class",
                messageFormat: $"The class '{{0}}' must derive from {BradotClasses.BradotObject} or a derived class",
                category: "Usage",
                DiagnosticSeverity.Error,
                isEnabledByDefault: true,
                $"The class must derive from {BradotClasses.BradotObject} or a derived class. Change the base type, or remove the '[GlobalClass]' attribute.",
                helpLinkUri: string.Format(_helpLinkFormat, "BR0401"));

        public static readonly DiagnosticDescriptor GlobalClassMustNotBeGenericRule =
            new DiagnosticDescriptor(id: "BR0402",
                ...
                helpLinkUri: string.Format(_helpLinkFormat, "BR0402"));
    }
}
