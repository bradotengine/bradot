...
{
    /// <inheritdoc cref="CreateAction(string, UndoRedo.MergeMode, BradotObject, bool)"/>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public void CreateAction(string name, UndoRedo.MergeMode mergeMode, BradotObject customContext)
    {
