...
namespace Bradot
{
    ...
    public struct Color : IEquatable<Color>
    {
        ...
        /// format (each byte represents a color channel).
        /// ARGB is more compatible with DirectX, but not used much in Bradot.
        /// </summary>
        ...
        /// format (each byte represents a color channel).
        /// RGBA is Bradot's default and recommended format.
        /// </summary>
        ...
        {
            return NativeFuncs.bradotsharp_color_from_ok_hsl(hue, saturation, lightness, alpha);
        }
