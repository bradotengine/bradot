...
namespace Bradot
{
    ...
    public static partial class BR
    {
        ...
        public static Variant BytesToVar(Span<byte> bytes)
        {
            ...
            NativeFuncs.bradotsharp_bytes_to_var(varBytes, bradot_bool.False, out bradot_variant ret);
        ...
        {
            using var varBytes = Marshaling.ConvertSystemArrayToNativePackedByteArray(bytes);
            NativeFuncs.bradotsharp_bytes_to_var(varBytes, bradot_bool.True, out bradot_variant ret);
            return Variant.CreateTakingOwnershipOfDisposableValue(ret);
        }
        ...
        /// <example>
        /// <code>
        /// Variant a = new Bradot.Collections.Array { 4, 2.5, 1.2 };
        /// BR.Print(a.VariantType == Variant.Type.Array); // Prints true
        ///
        /// var b = BR.Convert(a, Variant.Type.PackedByteArray);
        /// BR.Print(b); // Prints [4, 2, 1]
        /// BR.Print(b.VariantType == Variant.Type.Array); // Prints false
        /// </code>
        /// </example>
        ...
        {
            NativeFuncs.bradotsharp_convert((bradot_variant)what.NativeVar, (int)type, out bradot_variant ret);
            return Variant.CreateTakingOwnershipOfDisposableValue(ret);
        }
        ...
        /// <example>
        /// <code>
        /// BR.Print(BR.Hash("a")); // Prints 177670
        /// </code>
        /// </example>
        ...
        {
            return NativeFuncs.bradotsharp_hash((bradot_variant)var.NativeVar);
        }
        ...
        /// var main = BR.Load("res://main.tscn"); // main will contain a PackedScene resource.
        /// </code>
        /// </example>
        ...
        /// <code>
        /// // Load a scene called main located in the root of the project directory and cache it in a variable.
        /// var main = BR.Load&lt;PackedScene&gt;("res://main.tscn"); // main will contain a PackedScene resource.
        /// </code>
        /// </example>
        /// <param name="path">Path of the <see cref="Resource"/> to load.</param>
        ...
        public static void Print(string what)
        {
            ...
            NativeFuncs.bradotsharp_print(godotStr);
        }
        ...
        /// <example>
        /// <code>
        /// var a = new Bradot.Collections.Array { 1, 2, 3 };
        /// BR.Print("a", "b", a); // Prints ab[1, 2, 3]
        /// </code>
        /// </example>
        ...
        {
            using var godotStr = Marshaling.ConvertStringToNative(what);
            NativeFuncs.bradotsharp_print_rich(godotStr);
        }
        ...
        /// <example>
        /// <code>
        /// BR.PrintRich("[code][b]Hello world![/b][/code]"); // Prints out: [b]Hello world![/b]
        /// </code>
        /// </example>
        /// <param name="what">Arguments that will be printed.</param>
        ...
        {
            using var godotStr = Marshaling.ConvertStringToNative(what);
            NativeFuncs.bradotsharp_printerr(godotStr);
        }
        ...
        {
            using var godotStr = Marshaling.ConvertStringToNative(what);
            NativeFuncs.bradotsharp_printraw(godotStr);
        }
        ...
        public static void PrintS(params object[] what)
        {
            ...
            NativeFuncs.bradotsharp_prints(godotStr);
        }
        ...
        public static void PrintT(params object[] what)
        {
            string message = AppendPrintParams('\t', what);
            using var godotStr = Marshaling.ConvertStringToNative(message);
            NativeFuncs.bradotsharp_printt(godotStr);
        }

        [StackTraceHidden]
        private static void ErrPrintError(string message, bradot_error_handler_type type = bradot_error_handler_type.ERR_HANDLER_ERROR)
        {
            ...
            using bradot_string messageStr = Marshaling.ConvertStringToNative(message);
            using bradot_string callerNameStr = Marshaling.ConvertStringToNative(callerName);
            using bradot_string callerFilePathStr = Marshaling.ConvertStringToNative(callerFilePath);
            NativeFuncs.bradotsharp_err_print_error(callerNameStr, callerFilePathStr, callerLineNumber, messageStr, p_type: type);
        }

        /// <summary>
        /// Pushes an error message to Bradot's built-in debugger and to the OS terminal.
        ///
        /// Note: Errors printed this way will not pause project execution.
        /// </summary>
        /// <example>
        /// <code>
        /// BR.PushError("test error"); // Prints "test error" to debugger and terminal as error call
        /// </code>
        /// </example>
        ...
        /// <example>
        /// <code>
        /// BR.PushError("test_error"); // Prints "test error" to debugger and terminal as error call
        /// </code>
        /// </example>
        ...
        /// <summary>
        /// Pushes a warning message to Bradot's built-in debugger and to the OS terminal.
        /// </summary>
        /// <example>
        /// <code>
        /// BR.PushWarning("test warning"); // Prints "test warning" to debugger and terminal as warning call
        /// </code>
        /// </example>
        /// <param name="message">Warning message.</param>
        public static void PushWarning(string message)
        {
            ErrPrintError(message, type: bradot_error_handler_type.ERR_HANDLER_WARNING);
        }
        ...
        {
            ErrPrintError(AppendPrintParams(what), type: bradot_error_handler_type.ERR_HANDLER_WARNING);
        }
        ...
        /// <example>
        /// <code>
        /// BR.Randf(); // Returns e.g. 0.375671
        /// </code>
        /// </example>
        /// <returns>A random <see langword="float"/> number.</returns>
        public static float Randf()
        {
            return NativeFuncs.bradotsharp_randf();
        }
        ...
        {
            return NativeFuncs.bradotsharp_randfn(mean, deviation);
        }
        ...
        /// <example>
        /// <code>
        /// BR.Randi();           // Returns random integer between 0 and 2^32 - 1
        /// BR.Randi() % 20;      // Returns random integer between 0 and 19
        /// BR.Randi() % 100;     // Returns random integer between 0 and 99
        /// BR.Randi() % 100 + 1; // Returns random integer between 1 and 100
        /// </code>
        /// </example>
        /// <returns>A random <see langword="uint"/> number.</returns>
        public static uint Randi()
        {
            return NativeFuncs.bradotsharp_randi();
        }
        ...
        {
            NativeFuncs.bradotsharp_randomize();
        }
        ...
        /// <example>
        /// <code>
        /// BR.RandRange(0.0, 20.5);   // Returns e.g. 7.45315
        /// BR.RandRange(-10.0, 10.0); // Returns e.g. -3.844535
        /// </code>
        /// </example>
        /// <returns>A random <see langword="double"/> number inside the given range.</returns>
        public static double RandRange(double from, double to)
        {
            return NativeFuncs.bradotsharp_randf_range(from, to);
        }
        ...
        /// <example>
        /// <code>
        /// BR.RandRange(0, 1);      // Returns either 0 or 1
        /// BR.RandRange(-10, 1000); // Returns random integer between -10 and 1000
        /// </code>
        /// </example>
        /// <returns>A random <see langword="int"/> number inside the given range.</returns>
        public static int RandRange(int from, int to)
        {
            return NativeFuncs.bradotsharp_randi_range(from, to);
        }
        ...
        {
            return NativeFuncs.bradotsharp_rand_from_seed(seed, out seed);
        }
        ...
        /// <example>
        /// <code>
        /// ulong mySeed = (ulong)BR.Hash("Bradot Rocks");
        /// BR.Seed(mySeed);
        /// var a = BR.Randf() + BR.Randi();
        /// BR.Seed(mySeed);
        /// var b = BR.Randf() + BR.Randi();
        ...
        {
            NativeFuncs.bradotsharp_seed(seed);
        }
        ...
        /// var b = BR.StrToVar(a).AsBradotDictionary(); // b is a Dictionary
        /// BR.Print(b["a"]);                           // Prints 1
        /// </code>
        /// </example>
        ...
        public static Variant StrToVar(string str)
        {
            ...
            NativeFuncs.bradotsharp_str_to_var(godotStr, out bradot_variant ret);
            return Variant.CreateTakingOwnershipOfDisposableValue(ret);
        }
        ...
        {
            NativeFuncs.bradotsharp_var_to_bytes((bradot_variant)var.NativeVar, bradot_bool.False, out var varBytes);
            using (varBytes)
        ...
        {
            NativeFuncs.bradotsharp_var_to_bytes((bradot_variant)var.NativeVar, bradot_bool.True, out var varBytes);
            using (varBytes)
                return Marshaling.ConvertNativePackedByteArrayToSystemArray(varBytes);
        }
        ...
        /// <example>
        /// <code>
        /// var a = new Bradot.Collections.Dictionary { ["a"] = 1, ["b"] = 2 };
        /// BR.Print(BR.VarToStr(a));
        /// // Prints:
        /// // {
        /// //     "a": 1,
        /// //     "b": 2
        ...
        {
            NativeFuncs.bradotsharp_var_to_str((bradot_variant)var.NativeVar, out bradot_string ret);
            using (ret)
