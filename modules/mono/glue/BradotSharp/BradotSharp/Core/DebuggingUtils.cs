...
namespace Bradot
{
    internal static class DebuggingUtils
    {
        ...
        internal static void InstallTraceListener()
        {
            ...
            Trace.Listeners.Add(new BradotTraceListener());
        }

#pragma warning disable IDE1006 // Naming rule violation
        // ReSharper disable once InconsistentNaming
        [StructLayout(LayoutKind.Sequential)]
        internal ref struct bradot_stack_info
        {
            public bradot_string File;
            public bradot_string Func;
            public int Line;
        }

        // ReSharper disable once InconsistentNaming
        [StructLayout(LayoutKind.Sequential)]
        internal ref struct bradot_stack_info_vector
        {
            private IntPtr _writeProxy;
            private unsafe bradot_stack_info* _ptr;

            public readonly unsafe bradot_stack_info* Elements
            {
            ...
            public void Resize(int size)
            {
                ...
                var err = NativeFuncs.bradotsharp_stack_info_vector_resize(ref this, size);
                if (err != Error.Ok)
            ...
            public unsafe void Dispose()
            {
                if (_ptr == null)
                    return;
                NativeFuncs.bradotsharp_stack_info_vector_destroy(ref this);
                _ptr = null;
            }
        }
#pragma warning restore IDE1006
        ...
        internal static unsafe void GetCurrentStackInfo(void* destVector)
        {
            try
            {
                var vector = (bradot_stack_info_vector*)destVector;
                ...
                foreach (StackFrame frame in stackTrace.GetFrames())
                {
                    ...
                    bradot_stack_info* stackInfo = &vector->Elements[i];
