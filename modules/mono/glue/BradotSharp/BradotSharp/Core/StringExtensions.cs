...
namespace Bradot
{
    ...
    public static class StringExtensions
    {
        ...
        {
            using bradot_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.bradotsharp_string_to_camel_case(instanceStr, out bradot_string camelCase);
            using (camelCase)
        ...
        {
            using bradot_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.bradotsharp_string_to_pascal_case(instanceStr, out bradot_string pascalCase);
            using (pascalCase)
        ...
        {
            using bradot_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.bradotsharp_string_to_snake_case(instanceStr, out bradot_string snakeCase);
            using (snakeCase)
...
#pragma warning restore CA1309
        ...
        /// <example>
        /// <code>
        /// BR.Print("/path/to/file.txt".GetExtension())  // "txt"
        /// BR.Print("file.txt".GetExtension())  // "txt"
        /// BR.Print("file.sample.txt".GetExtension())  // "txt"
        /// BR.Print(".txt".GetExtension())  // "txt"
        /// BR.Print("file.txt.".GetExtension())  // "" (empty string)
        /// BR.Print("file.txt..".GetExtension())  // "" (empty string)
        /// BR.Print("txt".GetExtension())  // "" (empty string)
        /// BR.Print("".GetExtension())  // "" (empty string)
        /// </code>
        /// </example>
        ...
        /// <example>
        /// <code>
        /// BR.Print("1.7".IsValidFloat())  // Prints "True"
        /// BR.Print("24".IsValidFloat())  // Prints "True"
        /// BR.Print("7e3".IsValidFloat())  // Prints "True"
        /// BR.Print("Hello".IsValidFloat())  // Prints "False"
        /// </code>
        /// </example>
        /// <param name="instance">The string to check.</param>
        ...
        /// <example>
        /// <code>
        /// BR.Print("good_ident_1".IsValidIdentifier())  // Prints "True"
        /// BR.Print("1st_bad_ident".IsValidIdentifier())  // Prints "False"
        /// BR.Print("bad_ident_#2".IsValidIdentifier())  // Prints "False"
        /// </code>
        /// </example>
        /// <param name="instance">The string to check.</param>
        ...
        /// <example>
        /// <code>
        /// BR.Print("7".IsValidInt())  // Prints "True"
        /// BR.Print("14.6".IsValidInt())  // Prints "False"
        /// BR.Print("L".IsValidInt())  // Prints "False"
        /// BR.Print("+3".IsValidInt())  // Prints "True"
        /// BR.Print("-12".IsValidInt())  // Prints "True"
        /// </code>
        /// </example>
        /// <param name="instance">The string to check.</param>
...
#pragma warning restore CA5350
        ...
        {
            using bradot_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.bradotsharp_string_simplify_path(instanceStr, out bradot_string simplifiedPath);
