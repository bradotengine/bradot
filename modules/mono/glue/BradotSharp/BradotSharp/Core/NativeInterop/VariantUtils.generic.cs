...
public partial class VariantUtils
{
    ...
    {
        public static unsafe bradot_variant ToVariant(in T from) =>
            ToVariantCb != null ? ToVariantCb(from) : throw UnsupportedType<T>();

        public static unsafe T FromVariant(in bradot_variant variant) =>
            FromVariantCb != null ? FromVariantCb(variant) : throw UnsupportedType<T>();

        // ReSharper disable once StaticMemberInGenericType
        internal static unsafe delegate*<in T, bradot_variant> ToVariantCb;

        // ReSharper disable once StaticMemberInGenericType
        internal static unsafe delegate*<in bradot_variant, T> FromVariantCb;
    ...
    public static bradot_variant CreateFrom<[MustBeVariant] T>(in T from)
    {
        ...
        if (typeof(T) == typeof(Bradot.Collections.Dictionary))
            return CreateFromDictionary(UnsafeAs<Bradot.Collections.Dictionary>(from));

        if (typeof(T) == typeof(Bradot.Collections.Array))
            return CreateFromArray(UnsafeAs<Bradot.Collections.Array>(from));

        if (typeof(T) == typeof(Variant))
            return NativeFuncs.bradotsharp_variant_new_copy((bradot_variant)UnsafeAs<Variant>(from).NativeVar);
        ...
        if (typeof(BradotObject).IsAssignableFrom(typeof(T)))
            return CreateFromBradotObject(UnsafeAs<BradotObject>(from));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static T ConvertTo<[MustBeVariant] T>(in bradot_variant variant)
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        if (typeof(BradotObject).IsAssignableFrom(typeof(T)))
            return (T)(object)ConvertToBradotObject(variant);
