...
namespace Bradot
{
    ...
    /// It consists of a <see cref="Bradot.Basis"/> (first 3 columns) and a
    /// <see cref="Vector3"/> for the origin (last column).
    ///
    /// For more information, read this documentation article:
    /// https://docs.bradotengine.org/en/latest/tutorials/math/matrices_and_transforms.html
    /// </summary>
    [Serializable]
    ...
    {
        /// <summary>
        /// The <see cref="Bradot.Basis"/> of this transform. Contains the X, Y, and Z basis
        ...
        /// This is used as a replacement for <c>Transform()</c> in BRScript.
        ...
        /// </summary>
        /// <param name="basis">The <see cref="Bradot.Basis"/> to create the basis from.</param>
        /// <param name="origin">The origin vector, or column index 3.</param>
