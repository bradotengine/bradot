...
namespace Bradot
{
    ...
    {
        internal bradot_string_name.movable NativeValue;
        ...
        private StringName(bradot_string_name nativeValueToOwn)
        {
            NativeValue = (bradot_string_name.movable)nativeValueToOwn;
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static StringName CreateTakingOwnershipOfDisposableValue(bradot_string_name nativeValueToOwn)
        ...
        public StringName(string name)
        {
            ...
            {
                NativeValue = (bradot_string_name.movable)NativeFuncs.bradotsharp_string_name_new_from_string(name);
                _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
            }
        }
        ...
        public override string ToString()
        {
            ...
            var src = (bradot_string_name)NativeValue;
            NativeFuncs.bradotsharp_string_name_as_string(out bradot_string dest, src);
            using (dest)
        ...
        public static bool operator ==(StringName? left, in bradot_string_name right)
        {
            if (left is null)
        ...
        public static bool operator ==(in bradot_string_name left, StringName? right)
        {
            return right == left;
        }
        ...
        public bool Equals(in bradot_string_name other)
        {
