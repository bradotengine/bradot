...
{
    /// <summary>
    /// Wrapper around Bradot's Dictionary class, a dictionary of Variant
    ...
    public sealed class Dictionary :
        ...
        IDisposable
    {
        internal bradot_dictionary.movable NativeValue;
        ...
        public Dictionary()
        {
            NativeValue = (bradot_dictionary.movable)NativeFuncs.bradotsharp_dictionary_new();
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        private Dictionary(bradot_dictionary nativeValueToOwn)
        {
            NativeValue = (bradot_dictionary.movable)(nativeValueToOwn.IsAllocated ?
                nativeValueToOwn :
                NativeFuncs.bradotsharp_dictionary_new());
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static Dictionary CreateTakingOwnershipOfDisposableValue(bradot_dictionary nativeValueToOwn)
        ...
        /// referenced in the source dictionary. Note that any <see cref="BradotObject"/> derived
        /// elements will be shallow copied regardless of the <paramref name="deep"/>
        /// setting.
        /// </summary>
        /// <param name="deep">If <see langword="true"/>, performs a deep copy.</param>
        /// <returns>A new Bradot Dictionary.</returns>
        public Dictionary Duplicate(bool deep = false)
        {
            bradot_dictionary newDictionary;
            var self = (bradot_dictionary)NativeValue;
            NativeFuncs.bradotsharp_dictionary_duplicate(ref self, deep.ToBradotBool(), out newDictionary);
        ...
        public void Merge(Dictionary dictionary, bool overwrite = false)
        {
            ...
            var self = (bradot_dictionary)NativeValue;
            var other = (bradot_dictionary)dictionary.NativeValue;
            NativeFuncs.bradotsharp_dictionary_merge(ref self, in other, overwrite.ToBradotBool());
        }
        ...
        {
            var self = (bradot_dictionary)NativeValue;
            var otherVariant = (bradot_dictionary)other.NativeValue;
            return NativeFuncs.bradotsharp_dictionary_recursive_equal(ref self, otherVariant).ToBool();
        }
        ...
        public ICollection<Variant> Keys
        {
            get
            {
                bradot_array keysArray;
                var self = (bradot_dictionary)NativeValue;
                NativeFuncs.bradotsharp_dictionary_keys(ref self, out keysArray);
        ...
        public ICollection<Variant> Values
        {
            get
            {
                bradot_array valuesArray;
                var self = (bradot_dictionary)NativeValue;
                NativeFuncs.bradotsharp_dictionary_values(ref self, out valuesArray);
        ...
        private (Array keys, Array values, int count) GetKeyValuePairs()
        {
            ...
            int count = NativeFuncs.bradotsharp_dictionary_count(ref self);
        ...
        public Variant this[Variant key]
        {
            get
            {
                ...
                if (NativeFuncs.bradotsharp_dictionary_try_get_value(ref self,
                        (bradot_variant)key.NativeVar, out bradot_variant value).ToBool())
                {
            ...
            set
            {
                ...
                var self = (bradot_dictionary)NativeValue;
                NativeFuncs.bradotsharp_dictionary_set_value(ref self,
                    (bradot_variant)key.NativeVar, (bradot_variant)value.NativeVar);
            }
        }
        ...
        public void Add(Variant key, Variant value)
        {
            ...
            var variantKey = (bradot_variant)key.NativeVar;
            var self = (bradot_dictionary)NativeValue;

            if (NativeFuncs.bradotsharp_dictionary_contains_key(ref self, variantKey).ToBool())
                throw new ArgumentException("An element with the same key already exists.", nameof(key));

            bradot_variant variantValue = (bradot_variant)value.NativeVar;
            NativeFuncs.bradotsharp_dictionary_add(ref self, variantKey, variantValue);
        }
        ...
        public void Clear()
        {
            ...
            var self = (bradot_dictionary)NativeValue;
            NativeFuncs.bradotsharp_dictionary_clear(ref self);
        }
        ...
        {
            var self = (bradot_dictionary)NativeValue;
            return NativeFuncs.bradotsharp_dictionary_contains_key(ref self, (bradot_variant)key.NativeVar).ToBool();
        }

        bool ICollection<KeyValuePair<Variant, Variant>>.Contains(KeyValuePair<Variant, Variant> item)
        {
            bradot_variant variantKey = (bradot_variant)item.Key.NativeVar;
            var self = (bradot_dictionary)NativeValue;
            bool found = NativeFuncs.bradotsharp_dictionary_try_get_value(ref self,
                variantKey, out bradot_variant retValue).ToBool();
            ...
            using (retValue)
            {
                ...
                bradot_variant variantValue = (bradot_variant)item.Value.NativeVar;
                return NativeFuncs.bradotsharp_variant_equals(variantValue, retValue).ToBool();
            }
        }
        ...
        public bool Remove(Variant key)
        {
            ...
            var self = (bradot_dictionary)NativeValue;
            return NativeFuncs.bradotsharp_dictionary_remove_key(ref self, (bradot_variant)key.NativeVar).ToBool();
        }
        ...
        bool ICollection<KeyValuePair<Variant, Variant>>.Remove(KeyValuePair<Variant, Variant> item)
        {
            ...
            using (retValue)
            {
                ...
                bradot_variant variantValue = (bradot_variant)item.Value.NativeVar;
                if (NativeFuncs.bradotsharp_variant_equals(variantValue, retValue).ToBool())
                {
                    return NativeFuncs.bradotsharp_dictionary_remove_key(
        ...
        public int Count
        {
            ...
            {
                var self = (bradot_dictionary)NativeValue;
                return NativeFuncs.bradotsharp_dictionary_count(ref self);
            }
        }
        ...
        public void MakeReadOnly()
        {
            ...
            var self = (bradot_dictionary)NativeValue;
            NativeFuncs.bradotsharp_dictionary_make_read_only(ref self);
        }
        ...
        public bool TryGetValue(Variant key, out Variant value)
        {
            var self = (bradot_dictionary)NativeValue;
            bool found = NativeFuncs.bradotsharp_dictionary_try_get_value(ref self,
                (bradot_variant)key.NativeVar, out bradot_variant retValue).ToBool();
        ...
        {
            var self = (bradot_dictionary)NativeValue;
            NativeFuncs.bradotsharp_dictionary_key_value_pair_at(ref self, index,
                out bradot_variant key,
                out bradot_variant value);
        ...
        {
            var self = (bradot_dictionary)NativeValue;
            NativeFuncs.bradotsharp_dictionary_to_string(ref self, out bradot_string str);
            using (str)
    ...
    internal interface IGenericBradotDictionary
    {
        public Dictionary UnderlyingDictionary { get; }
    }

    /// <summary>
    /// Typed wrapper around Bradot's Dictionary class, a dictionary of Variant
    /// typed elements allocated in the engine in C++. Useful when
    ...
    public class Dictionary<[MustBeVariant] TKey, [MustBeVariant] TValue> :
        ...
        IGenericBradotDictionary
    {
        private static bradot_variant ToVariantFunc(in Dictionary<TKey, TValue> bradotDictionary) =>
            VariantUtils.CreateFromDictionary(bradotDictionary);

        private static Dictionary<TKey, TValue> FromVariantFunc(in bradot_variant variant) =>
        ...
        Dictionary IGenericBradotDictionary.UnderlyingDictionary => _underlyingDict;

        internal ref bradot_dictionary.movable NativeValue
        {
        ...
        internal static Dictionary<TKey, TValue> CreateTakingOwnershipOfDisposableValue(
            bradot_dictionary nativeValueToOwn)
        ...
        /// <returns>A new Bradot Dictionary, or <see langword="null"/> if <see paramref="from"/> was null.</returns>
        ...
        public TValue this[TKey key]
        {
            get
            {
                ...
                var self = (bradot_dictionary)_underlyingDict.NativeValue;

                if (NativeFuncs.bradotsharp_dictionary_try_get_value(ref self,
                        variantKey, out bradot_variant value).ToBool())
                {
                    using (value)
        ...
        public ICollection<TKey> Keys
        {
            get
            {
                bradot_array keyArray;
                var self = (bradot_dictionary)_underlyingDict.NativeValue;
                NativeFuncs.bradotsharp_dictionary_keys(ref self, out keyArray);
        ...
        public bool ContainsKey(TKey key)
        {
            using var variantKey = VariantUtils.CreateFrom(key);
            var self = (bradot_dictionary)_underlyingDict.NativeValue;
            return NativeFuncs.bradotsharp_dictionary_contains_key(ref self, variantKey).ToBool();
        }
        ...
        public bool Remove(TKey key)
        {
            ...
            using var variantKey = VariantUtils.CreateFrom(key);
            var self = (bradot_dictionary)_underlyingDict.NativeValue;
            return NativeFuncs.bradotsharp_dictionary_remove_key(ref self, variantKey).ToBool();
        }
        ...
        public static explicit operator Dictionary<TKey, TValue>(Variant from) =>
            from.AsBradotDictionary<TKey, TValue>();
