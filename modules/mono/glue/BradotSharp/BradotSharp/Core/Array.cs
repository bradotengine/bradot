...
namespace Bradot.Collections
{
    /// <summary>
    /// Wrapper around Bradot's Array class, an array of Variant
...
#pragma warning restore CA1710
        ...
        IDisposable
    {
        internal bradot_array.movable NativeValue;
        ...
        public Array()
        {
            NativeValue = (bradot_array.movable)NativeFuncs.bradotsharp_array_new();
        ...
        /// </exception>
        /// <returns>A new Godot Array.</returns>
        public Array(ReadOnlySpan<BradotObject> array)
        {
            if (array == null)
                throw new ArgumentNullException(nameof(array));
        ...
        private Array(bradot_array nativeValueToOwn)
        {
            NativeValue = (bradot_array.movable)(nativeValueToOwn.IsAllocated ?
                nativeValueToOwn :
                NativeFuncs.bradotsharp_array_new());
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static Array CreateTakingOwnershipOfDisposableValue(bradot_array nativeValueToOwn)
        ...
        /// referenced in the source array. Note that any <see cref="BradotObject"/> derived
        ...
        {
            bradot_array newArray;
            var self = (bradot_array)NativeValue;
            NativeFuncs.bradotsharp_array_duplicate(ref self, deep.ToBradotBool(), out newArray);
        ...
        /// Note: If <paramref name="value"/> is of a reference type (<see cref="BradotObject"/>
        ...
        /// <example>
        /// <code>
        /// var array = new Bradot.Collections.Array();
        /// array.Resize(10);
        ...
        public void Fill(Variant value)
        {
            ...
            bradot_variant variantValue = (bradot_variant)value.NativeVar;
            var self = (bradot_array)NativeValue;
            NativeFuncs.bradotsharp_array_fill(ref self, variantValue);
        }
        ...
        public Variant Max()
        {
            bradot_variant resVariant;
            var self = (bradot_array)NativeValue;
            NativeFuncs.bradotsharp_array_max(ref self, out resVariant);
        ...
        public Variant Min()
        {
            bradot_variant resVariant;
            var self = (bradot_array)NativeValue;
            NativeFuncs.bradotsharp_array_min(ref self, out resVariant);
            return Variant.CreateTakingOwnershipOfDisposableValue(resVariant);
        }
        ...
        /// <example>
        /// <code>
        /// var array = new Bradot.Collections.Array { 1, 2, 3, 4 };
        /// BR.Print(array.PickRandom()); // Prints either of the four numbers.
        /// </code>
        /// </example>
        ...
        public Variant PickRandom()
        {
            bradot_variant resVariant;
            var self = (bradot_array)NativeValue;
            NativeFuncs.bradotsharp_array_pick_random(ref self, out resVariant);
            return Variant.CreateTakingOwnershipOfDisposableValue(resVariant);
        }
        ...
        {
            var self = (bradot_array)NativeValue;
            var otherVariant = (bradot_array)other.NativeValue;
            return NativeFuncs.bradotsharp_array_recursive_equal(ref self, otherVariant).ToBool();
        }
        ...
        public Error Resize(int newSize)
        {
            ...
            var self = (bradot_array)NativeValue;
            return NativeFuncs.bradotsharp_array_resize(ref self, newSize);
        }
        ...
        public void Reverse()
        {
            ...
            var self = (bradot_array)NativeValue;
            NativeFuncs.bradotsharp_array_reverse(ref self);
        }
        ...
        /// such as <see cref="BR.Randi"/>. Call <see cref="BR.Randomize"/> to
        ...
        public void Shuffle()
        {
            ...
            var self = (bradot_array)NativeValue;
            NativeFuncs.bradotsharp_array_shuffle(ref self);
        }
        ...
        public Array GetSliceRange(int start, int end, int step = 1, bool deep = false)
        {
            bradot_array newArray;
            var self = (bradot_array)NativeValue;
            NativeFuncs.bradotsharp_array_slice(ref self, start, end, step, deep.ToBradotBool(), out newArray);
            return CreateTakingOwnershipOfDisposableValue(newArray);
        }
        ...
        /// <example>
        /// <code>
        /// var strings = new Bradot.Collections.Array { "string1", "string2", "string10", "string11" };
        /// strings.Sort();
        /// BR.Print(strings); // Prints [string1, string10, string11, string2]
        /// </code>
        /// </example>
        /// <exception cref="InvalidOperationException">
        /// The array is read-only.
        ...
        public void Sort()
        {
            ...
            var self = (bradot_array)NativeValue;
            NativeFuncs.bradotsharp_array_sort(ref self);
        }
        ...
        public unsafe Variant this[int index]
        {
            get
            {
                GetVariantBorrowElementAt(index, out bradot_variant borrowElem);
            ...
            set
            {
                ...
                var self = (bradot_array)NativeValue;
                bradot_variant* ptrw = NativeFuncs.bradotsharp_array_ptrw(ref self);
                bradot_variant* itemPtr = &ptrw[index];
                (*itemPtr).Dispose();
        ...
        /// This is the same as <c>append</c> or <c>push_back</c> in BRScript.
        /// </summary>
        /// <exception cref="InvalidOperationException">
        /// The array is read-only.
        /// </exception>
        ...
        public void Add(Variant item)
        {
            ...
            bradot_variant variantValue = (bradot_variant)item.NativeVar;
            var self = (bradot_array)NativeValue;
            _ = NativeFuncs.bradotsharp_array_add(ref self, variantValue);
        }
        ...
        public void AddRange<[MustBeVariant] T>(IEnumerable<T> collection)
        {
            ...
            {
                var self = (bradot_array)NativeValue;
                var collectionNative = (bradot_array)array.NativeValue;
                _ = NativeFuncs.bradotsharp_array_add_range(ref self, collectionNative);
                return;
            }
            if (collection is Array<T> typedArray)
            {
                var self = (bradot_array)NativeValue;
                var collectionNative = (bradot_array)typedArray.NativeValue;
                _ = NativeFuncs.bradotsharp_array_add_range(ref self, collectionNative);
                return;
            }
        ...
        public int BinarySearch(int index, int count, Variant item)
        {
            ...
            bradot_variant variantValue = (bradot_variant)item.NativeVar;
            var self = (bradot_array)NativeValue;
            return NativeFuncs.bradotsharp_array_binary_search(ref self, index, count, variantValue);
        }
        ...
        /// <example>
        /// <code>
        /// var arr = new Bradot.Collections.Array { "inside", 7 };
        /// BR.Print(arr.Contains("inside")); // True
        /// BR.Print(arr.Contains("outside")); // False
        /// BR.Print(arr.Contains(7)); // True
        /// BR.Print(arr.Contains("7")); // False
        /// </code>
        /// </example>
        ...
        public int IndexOf(Variant item)
        {
            ...
            bradot_variant variantValue = (bradot_variant)item.NativeVar;
            var self = (bradot_array)NativeValue;
            return NativeFuncs.bradotsharp_array_index_of(ref self, variantValue);
        }
        ...
        public int IndexOf(Variant item, int index)
        {
            ...
            bradot_variant variantValue = (bradot_variant)item.NativeVar;
            var self = (bradot_array)NativeValue;
            return NativeFuncs.bradotsharp_array_index_of(ref self, variantValue, index);
        }
        ...
        public int LastIndexOf(Variant item)
        {
            ...
            bradot_variant variantValue = (bradot_variant)item.NativeVar;
            var self = (bradot_array)NativeValue;
            return NativeFuncs.bradotsharp_array_last_index_of(ref self, variantValue, Count - 1);
        }
        ...
        public int LastIndexOf(Variant item, int index)
        {
            ...
            bradot_variant variantValue = (bradot_variant)item.NativeVar;
            var self = (bradot_array)NativeValue;
            return NativeFuncs.bradotsharp_array_last_index_of(ref self, variantValue, index);
        }
        ...
        public void Insert(int index, Variant item)
        {
            ...
            bradot_variant variantValue = (bradot_variant)item.NativeVar;
            var self = (bradot_array)NativeValue;
            NativeFuncs.bradotsharp_array_insert(ref self, index, variantValue);
        }
        ...
        public void RemoveAt(int index)
        {
            ...
            var self = (bradot_array)NativeValue;
            NativeFuncs.bradotsharp_array_remove_at(ref self, index);
        }
        ...
        public void MakeReadOnly()
        {
            ...
            var self = (bradot_array)NativeValue;
            NativeFuncs.bradotsharp_array_make_read_only(ref self);
        }
        ...
        {
            var self = (bradot_array)NativeValue;
            NativeFuncs.bradotsharp_array_to_string(ref self, out bradot_string str);
            using (str)
        ...
        /// <paramref name="index"/> is less than 0 or greater than the array's size.
        /// </exception>
        internal void GetVariantBorrowElementAt(int index, out bradot_variant elem)
        {
            if (index < 0 || index >= Count)
                throw new ArgumentOutOfRangeException(nameof(index));
        ...
        /// The variant returned via the <paramref name="elem"/> parameter is owned by the Array and must not be disposed.
        /// </summary>
        internal unsafe void GetVariantBorrowElementAtUnchecked(int index, out bradot_variant elem)
        {
    ...
    internal interface IGenericBradotArray
    {
        public Array UnderlyingArray { get; }
    }

    /// <summary>
    /// Typed wrapper around Bradot's Array class, an array of Variant
    /// typed elements allocated in the engine in C++. Useful when
    /// interfacing with the engine. Otherwise prefer .NET collections
    ...
    public sealed class Array<[MustBeVariant] T> :
        ...
        IGenericBradotArray
    {
        private static bradot_variant ToVariantFunc(in Array<T> godotArray) =>
            VariantUtils.CreateFromArray(godotArray);

        private static Array<T> FromVariantFunc(in bradot_variant variant) =>
        ...
        Array IGenericBradotArray.UnderlyingArray => _underlyingArray;

        internal ref bradot_array.movable NativeValue
        {
        ...
        // Explicit name to make it very clear
        internal static Array<T> CreateTakingOwnershipOfDisposableValue(bradot_array nativeValueToOwn)
        ...
        /// <example>
        /// <code>
        /// var array = new Bradot.Collections.Array&lt;int&gt;();
        /// array.Resize(10);
        /// array.Fill(0); // Initialize the 10 elements to 0.
        /// </code>
        /// </example>
        ...
        public void Fill(T value)
        {
            ...
            bradot_variant variantValue = VariantUtils.CreateFrom(value);
            var self = (bradot_array)_underlyingArray.NativeValue;
            NativeFuncs.bradotsharp_array_fill(ref self, variantValue);
        }
        ...
        /// <example>
        /// <code>
        /// var array = new Bradot.Collections.Array&lt;int&gt; { 1, 2, 3, 4 };
        /// BR.Print(array.PickRandom()); // Prints either of the four numbers.
        /// </code>
        /// </example>
        /// <returns>A random element from the array.</returns>
        ...
        /// <example>
        /// <code>
        /// var strings = new Bradot.Collections.Array&lt;string&gt; { "string1", "string2", "string10", "string11" };
        /// strings.Sort();
        /// BR.Print(strings); // Prints [string1, string10, string11, string2]
        /// </code>
        /// </example>
        ...
        public unsafe T this[int index]
        {
            get
            {
                _underlyingArray.GetVariantBorrowElementAt(index, out bradot_variant borrowElem);
        ...
        public int IndexOf(T item, int index)
        {
            ...
            bradot_variant variantValue = VariantUtils.CreateFrom(item);
            var self = (bradot_array)_underlyingArray.NativeValue;
            return NativeFuncs.bradotsharp_array_index_of(ref self, variantValue, index);
        }
        ...
        public void AddRange(IEnumerable<T> collection)
        {
            ...
            {
                var self = (bradot_array)_underlyingArray.NativeValue;
                var collectionNative = (bradot_array)typedArray._underlyingArray.NativeValue;
                _ = NativeFuncs.bradotsharp_array_add_range(ref self, collectionNative);
                return;
            }
        ...
        /// <example>
        /// <code>
        /// var arr = new Bradot.Collections.Array&lt;string&gt; { "inside", "7" };
        /// BR.Print(arr.Contains("inside")); // True
        /// BR.Print(arr.Contains("outside")); // False
        /// BR.Print(arr.Contains(7)); // False
        /// BR.Print(arr.Contains("7")); // True
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Array<T>(Variant from) => from.AsBradotArray<T>();
