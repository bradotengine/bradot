...
namespace Bradot
{
    ...
    {
        internal bradot_node_path.movable NativeValue;
        ...
        private NodePath(bradot_node_path nativeValueToOwn)
        {
            NativeValue = (bradot_node_path.movable)nativeValueToOwn;
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static NodePath CreateTakingOwnershipOfDisposableValue(bradot_node_path nativeValueToOwn)
        ...
        public NodePath(string path)
        {
            ...
            {
                NativeValue = (bradot_node_path.movable)NativeFuncs.bradotsharp_node_path_new_from_string(path);
                _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
            }
        }
        ...
        public override string ToString()
        {
            ...
            var src = (bradot_node_path)NativeValue;
            NativeFuncs.bradotsharp_node_path_as_string(out bradot_string dest, src);
            using (dest)
        ...
        /// BR.Print(propertyPath); // :position:x
        /// </code>
        /// </example>
        /// <returns>The <see cref="NodePath"/> as a pure property path.</returns>
        public NodePath GetAsPropertyPath()
        {
            bradot_node_path propertyPath = default;
            var self = (bradot_node_path)NativeValue;
            NativeFuncs.bradotsharp_node_path_get_as_property_path(self, ref propertyPath);
        ...
        /// BR.Print(nodepath.GetConcatenatedNames()); // Path2D/PathFollow2D/Sprite2D
        /// </code>
        /// </example>
        ...
        {
            var self = (bradot_node_path)NativeValue;
            NativeFuncs.bradotsharp_node_path_get_concatenated_names(self, out bradot_string names);
            using (names)
        ...
        /// <code>
        /// var nodepath = new NodePath("Path2D/PathFollow2D/Sprite2D:texture:load_path");
        /// BR.Print(nodepath.GetConcatenatedSubnames()); // texture:load_path
        /// </code>
        /// </example>
        ...
        {
            var self = (bradot_node_path)NativeValue;
            NativeFuncs.bradotsharp_node_path_get_concatenated_subnames(self, out bradot_string subNames);
            using (subNames)
        ...
        /// BR.Print(nodePath.GetName(0)); // Path2D
        /// BR.Print(nodePath.GetName(1)); // PathFollow2D
        /// BR.Print(nodePath.GetName(2)); // Sprite
        /// </code>
        /// </example>
        ...
        {
            var self = (bradot_node_path)NativeValue;
            NativeFuncs.bradotsharp_node_path_get_name(self, idx, out bradot_string name);
            using (name)
        ...
        {
            var self = (bradot_node_path)NativeValue;
            return NativeFuncs.bradotsharp_node_path_get_name_count(self);
        }
        ...
        {
            var self = (bradot_node_path)NativeValue;
            NativeFuncs.bradotsharp_node_path_get_subname(self, idx, out bradot_string subName);
            using (subName)
        ...
        {
            var self = (bradot_node_path)NativeValue;
            return NativeFuncs.bradotsharp_node_path_get_subname_count(self);
        }
        ...
        {
            var self = (bradot_node_path)NativeValue;
            return NativeFuncs.bradotsharp_node_path_is_absolute(self).ToBool();
        }
        ...
        public bool Equals([NotNullWhen(true)] NodePath? other)
        {
            if (other is null)
                return false;
            var self = (bradot_node_path)NativeValue;
            var otherNative = (bradot_node_path)other.NativeValue;
            return NativeFuncs.bradotsharp_node_path_equals(self, otherNative).ToBool();
        }
        ...
        {
            var self = (bradot_node_path)NativeValue;
            return NativeFuncs.bradotsharp_node_path_hash(self);
        }
    }
}
