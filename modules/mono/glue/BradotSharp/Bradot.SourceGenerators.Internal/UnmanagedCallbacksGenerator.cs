...
namespace Bradot.SourceGenerators.Internal;
        ...
        foreach (var callback in data.Methods)
        {
            ...
            for (int i = 0; i < callback.Parameters.Length; i++)
            {
                ...
                if (parameter.RefKind == RefKind.Out)
                {
                    ...
                    if (IsBradotInteropStruct(parameter.Type))
...
");
        ...
        foreach (var callback in data.Methods)
        {
            ...
            foreach (var parameter in callback.Parameters)
            {
                if (IsByRefParameter(parameter))
                {
                    if (IsBradotInteropStruct(parameter.Type) || parameter.Type.IsValueType)
                    {
    ...
    private static bool IsBradotInteropStruct(ITypeSymbol type) =>
        _bradotInteropStructs.Contains(type.FullQualifiedNameOmitGlobal());
    ...
    private static readonly string[] _bradotInteropStructs =
    {
        "Bradot.NativeInterop.bradot_ref",
        "Bradot.NativeInterop.bradot_variant_call_error",
        "Bradot.NativeInterop.bradot_variant",
        "Bradot.NativeInterop.bradot_string",
        "Bradot.NativeInterop.bradot_string_name",
        "Bradot.NativeInterop.bradot_node_path",
        "Bradot.NativeInterop.bradot_signal",
        "Bradot.NativeInterop.bradot_callable",
        "Bradot.NativeInterop.bradot_array",
        "Bradot.NativeInterop.bradot_dictionary",
        "Bradot.NativeInterop.bradot_packed_byte_array",
        "Bradot.NativeInterop.bradot_packed_int32_array",
        "Bradot.NativeInterop.bradot_packed_int64_array",
        "Bradot.NativeInterop.bradot_packed_float32_array",
        "Bradot.NativeInterop.bradot_packed_float64_array",
        "Bradot.NativeInterop.bradot_packed_string_array",
        "Bradot.NativeInterop.bradot_packed_vector2_array",
        "Bradot.NativeInterop.bradot_packed_vector3_array",
        "Bradot.NativeInterop.bradot_packed_vector4_array",
        "Bradot.NativeInterop.bradot_packed_color_array",
    };
}
