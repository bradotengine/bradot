...
for file in sys.argv[1:]:
    ...
    for idx, line in enumerate(lines):
        ...
        if header_start < 0:
            ...
            if sline.startswith("/**********"):  # Bradot header starts this way.
                header_start = idx
            else:
                HEADER_CHECK_OFFSET = 0  # There is no Bradot header.
                break
        else:
            if not sline.startswith("*") and not sline.startswith("/*"):  # Not in the Bradot header anymore.
                HEADER_CHECK_OFFSET = idx + 1  # The include should be two lines below the Bradot header.
                break
