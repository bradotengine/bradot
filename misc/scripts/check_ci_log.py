...
if (
    ...
    print("FATAL ERROR: Bradot has been crashed.")
    sys.exit(52)

# Finding memory leaks in Bradot is quite difficult, because we need to take into
...
# It may happen that Bradot detects leaking nodes/resources and removes them, so
...
# For now Bradot leaks a lot of rendering stuff so for now we just show info
