...
if [ ! -f "version.py" ]; then
  echo "Warning: This script is intended to be run from the root of the Bradot repository."
...
while read -r file; do
    ...
    wget -nv --retry-on-http-error=503 --tries=5 --timeout=60 -cO "$reference_file" "https://raw.githubusercontent.com/bradotengine/bradot-cpp/bradot-$reference_tag/brextension/extension_api.json" || has_problems=1
